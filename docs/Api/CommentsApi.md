...
try {
    $result = $apiInstance->getComment($id);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->updateComment($api_comment);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **api_comment** | [**\Swagger\Client\Model\APIComment**](../Model/APIComment.md)| The Comment to add |
