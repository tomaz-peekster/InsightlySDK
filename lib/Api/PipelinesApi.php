...
class PipelinesApi
{
    ...
    {
        $this->getPipelineWithHttpInfo($id);
    }
     ...
     */
    public function getPipelineAsync($id)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPipelineAsyncWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->getPipelineRequest($id);
     ...
     */
    protected function getPipelineRequest($id)
    {
     ...
     */
    public function getPipelines($skip = null, $top = null, $count_total = 'false')
    {
     ...
     */
    public function getPipelinesWithHttpInfo($skip = null, $top = null, $count_total = 'false')
    {
        $returnType = '\Swagger\Client\Model\Pipeline[]';
        $request = $this->getPipelinesRequest($skip, $top, $count_total);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPipelinesAsync($skip = null, $top = null, $count_total = 'false')
    {
        return $this->getPipelinesAsyncWithHttpInfo($skip, $top, $count_total)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPipelinesAsyncWithHttpInfo($skip = null, $top = null, $count_total = 'false')
    {
        $returnType = '\Swagger\Client\Model\Pipeline[]';
        $request = $this->getPipelinesRequest($skip, $top, $count_total);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPipelinesRequest($skip = null, $top = null, $count_total = 'false')
    {
