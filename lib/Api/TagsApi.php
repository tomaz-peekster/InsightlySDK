...
class TagsApi
{
     ...
     */
    public function getTags($record_type, $skip = null, $top = null, $count_total = 'false')
    {
     ...
     */
    public function getTagsWithHttpInfo($record_type, $skip = null, $top = null, $count_total = 'false')
    {
        $returnType = '\Swagger\Client\Model\Tag[]';
        $request = $this->getTagsRequest($record_type, $skip, $top, $count_total);
     ...
     */
    public function getTagsAsync($record_type, $skip = null, $top = null, $count_total = 'false')
    {
        return $this->getTagsAsyncWithHttpInfo($record_type, $skip, $top, $count_total)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTagsAsyncWithHttpInfo($record_type, $skip = null, $top = null, $count_total = 'false')
    {
        $returnType = '\Swagger\Client\Model\Tag[]';
        $request = $this->getTagsRequest($record_type, $skip, $top, $count_total);
     ...
     */
    protected function getTagsRequest($record_type, $skip = null, $top = null, $count_total = 'false')
    {
