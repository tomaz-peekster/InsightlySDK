 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class APIOpportunity implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerFormats = [
        ...
        'opportunity_state_reason_id' => 'int64',
        'image_url' => null,
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['opportunity_name']) && (strlen($this->container['opportunity_name']) < 0)) {
            $invalidProperties[] = "invalid value for 'opportunity_name', the character length must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['opportunity_details']) && (strlen($this->container['opportunity_details']) < 0)) {
            $invalidProperties[] = "invalid value for 'opportunity_details', the character length must be bigger than or equal to 0.";
        }

        if ($this->container['opportunity_state'] === null) {
            $invalidProperties[] = "'opportunity_state' can't be null";
        }
     ...
     *
     * @param int $opportunity_state_reason_id opportunity_state_reason_id
     *
     * @return $this
     */
