 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class APIOrganisation implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((strlen($this->container['organisation_name']) < 0)) {
            $invalidProperties[] = "invalid value for 'organisation_name', the character length must be bigger than or equal to 0.";
        }
     ...
     * Sets dates
     *
     * @param \Swagger\Client\Model\APIOrganisationDate[] $dates dates
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\APIOrganisationLink[] $organisationlinks organisationlinks
     *
     * @return $this
     */
