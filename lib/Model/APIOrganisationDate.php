 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class APIOrganisationDate implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['occasion_name']) && (strlen($this->container['occasion_name']) > 128)) {
            $invalidProperties[] = "invalid value for 'occasion_name', the character length must be smaller than or equal to 128.";
        }
